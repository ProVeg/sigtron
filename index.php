...
<form action="generate.php" method="post" target="preview">
  <table>
    ...
    <tr><th>Phone:</th><td><input onchange="this.form.submit()" type="text" name="phone" value="<?php echo $values[3] ? $values[3] : "+49 30 2902825 331"; ?>"> (replace extension or whole number!)</td></tr>
    <tr><th>Additional text:</th><td><input onchange="this.form.submit()" type="text" name="additional" value="<?php echo $values[4]; ?>"> (fax, mobile, …)</td></tr>
...
<p><a href="https://github.com/ProVeg/sigtron">SigTron 3000™ on Github</a></p>